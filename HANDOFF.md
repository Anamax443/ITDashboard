...
- Live commit: `1327cdd` (+ this doc-sweep commit once deployed; verify `/version` after push)
- Schema: migrations 001–054 · Tests: 112 (Vitest) · Collectors: eventlog, disk, services, perf, reachability, ports, mikrotik, **unifi**, printer-supplies, shared-printers (all in-process on `.213`)
