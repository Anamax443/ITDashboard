...
const VALID_STEPS: RetentionStepName[] = ['events_purge', 'activity_log_purge', 'pc_user_history_purge', 'pc_logon_events_purge', 'perf_purge', 'ad_sync_runs_purge', 'dhcp_leases_purge', 'device_ip_history_purge', 'ping_samples_purge', 'events_dedup'];
