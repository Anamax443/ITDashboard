...
<section class="slide">
  ...
  <div class="grid g2">
    <div>
      ...
      <p class="small muted"><strong>Novinky (20.&nbsp;7.&nbsp;2026):</strong> měření se spolehlivě přiřadí <strong>správnému stroji</strong> (podle MAC z DHCP a jména, kterým se stroj sám ohlásí, ne podle staré IP z inventáře), <strong>upload</strong> se měří přesně (dřív ho technické omezení podhodnocovalo ~3×) a tlačítko <strong>Zastavit</strong> zastaví měření okamžitě.</p>
    </div>
...
<section class="slide">
  ...
  <div class="grid g2">
    <div>
      ...
      <p class="small muted"><strong>Recent (2026-07-20):</strong> a measurement is reliably attributed to the <strong>right machine</strong> (by its MAC from DHCP and the name it reports about itself, not a stale inventory IP), <strong>upload</strong> is now measured accurately (a technical limit used to understate it by ~3×), and the <strong>Stop</strong> button halts the measurement immediately.</p>
    </div>
