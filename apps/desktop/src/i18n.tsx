...
const dict = {
  cs: {
    ...
    'settings.field.diskAlertsHelp': 'Sledované PC se zaškrtávají v záložce Počítače (sloupec 📧 Disk). Vyhodnocují se jejich disky podle kritického prahu a scope z nastavení Disky výše. Před testem ulož nastavení.',
  ...
  en: {
    ...
    'settings.field.diskAlertsHelp': 'Watched PCs are ticked in the Computers tab (📧 Disk column). Their disks are evaluated against the critical threshold + scope from the Disks settings above. Save settings before testing.',
