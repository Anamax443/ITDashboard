...
const dict = {
  cs: {
    ...
    'actions.adminUserHint': 'Pro launch akcí se používá Windows runas /user:%ITD_ADMIN_USER% pokud máš nastavenou tu env variable (User Environment Variables). Nechá-li se prázdná, akce běží jako tvůj přihlášený účet.',
  ...
  en: {
    ...
    'actions.adminUserHint': 'Launch actions will use Windows runas /user:%ITD_ADMIN_USER% when that env variable is set in User Environment Variables. Leave it unset to run actions as your logged-in account.',
