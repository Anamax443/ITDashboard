...
const dict = {
  cs: {
    ...
    'devices.latencyTip': 'Průměrná odezva (RTT) z posledního měření (ping ×4). Zobrazuje se od 5 ms výš; ≥ 50 ms žlutě (pomalý/přetížený spoj).',
  ...
  en: {
    ...
    'devices.latencyTip': 'Average round-trip (RTT) from the last measurement (ping ×4). Shown from 5 ms up; ≥ 50 ms in amber (slow/congested link).',
    'cat.printer': 'Printer',
    'cat.phone': 'Phone',
    'cat.pc': 'PC / laptop',
    'cat.server': 'Server',
