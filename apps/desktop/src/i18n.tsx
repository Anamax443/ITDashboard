...
const dict = {
  cs: {
    ...
    'ports.help': 'Aktuální stav dostupnosti klíčových TCP portů (SMB, RDP, Kerberos, DNS…) na sledovaných PC. Porty a timeout se berou z Nastavení (port-checky fáze 2). Sonda běží na pozadí; „Probnout teď" obnoví celou flotilu, „Ping" u řádku živě otestuje jeden stroj (ICMP ping + TCP porty). ● = otevřený (s latencí), ○ = zavřený, — = offline / neznámé.',
    'ports.machines': 'strojů',
    'ports.withIssues': 'se zavřeným portem',
    'ports.offline': 'offline',
    'ports.onlyIssues': 'jen problémy',
    'ports.probeNow': 'Probnout teď',
    'ports.probing': 'Probíhá sonda…',
    'ports.ping': 'Ping',
  ...
  en: {
    ...
    'ports.help': 'Current reachability of key TCP ports (SMB, RDP, Kerberos, DNS…) on watched PCs. The port list and timeout come from Settings (phase-2 port checks). A background probe keeps it fresh; "Probe now" refreshes the whole fleet, the per-row "Ping" live-tests one machine (ICMP ping + TCP ports). ● = open (with latency), ○ = closed, — = offline / unknown.',
    'ports.machines': 'machines',
    'ports.withIssues': 'with a closed port',
    'ports.offline': 'offline',
    'ports.onlyIssues': 'only issues',
    'ports.probeNow': 'Probe now',
    'ports.probing': 'Probing…',
    'ports.ping': 'Ping',
