...
const dict = {
  cs: {
    ...
    'settings.field.eventsDedupEnabled': 'Mazat duplicitní eventy (denní pass)',
    ...
    'settings.retention.runNow': '▶ Spustit retenci teď',
  ...
  en: {
    ...
    'settings.field.eventsDedupEnabled': 'Delete duplicate events (daily pass)',
    ...
    'settings.unit.hour24': 'h (0-23)',
    'settings.retention.runNow': '▶ Run retention now',
