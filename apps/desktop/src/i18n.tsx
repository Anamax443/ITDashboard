...
const dict = {
  cs: {
    ...
    'os.filterLabel': 'OS',
    'health.reinstall': 'Kandidáti na přeinstalaci',
    ...
    'settings.section.faulty': 'Vadné PC / kandidáti na přeinstalaci',
    'settings.section.faultyDesc': 'Skóruje počítače podle kumulace kritických/chybových/varovných eventů za okno. Tlumený mix: příspěvek každého typu eventu (provider+ID) je zastropován (jeden ukecaný ovladač PC nepotopí), k tomu bonus za počet různých chyb a počet dní s chybami. PC ≥ "Sledovat" se vejde do žluté dlaždice, ≥ "Riziko" do červené (kandidát na přeinstalaci). Váhy critical×10 / error×3 / warning×1 jsou laditelné v DB (faulty.weight_*).',
  ...
  en: {
    ...
    'os.filterLabel': 'OS',
    'health.reinstall': 'Reinstall candidates',
    'health.watch': 'Watch',
    'health.score': 'score',
    'health.types': 'types',
    'health.days': 'days',
    ...
    'settings.section.faulty': 'Faulty PCs / reinstall candidates',
    'settings.section.faultyDesc': 'Scores PCs by accumulated critical/error/warning events over a window. Damped blend: each event type (provider+ID) contributes at most a capped number of occurrences (so one chatty driver can\'t flag a healthy box), plus a bonus for how many DIFFERENT errors and how many DAYS had errors. A PC at or above "Watch" lands in the amber tile, at or above "Risk" in the red tile (reinstall candidate). Severity weights critical×10 / error×3 / warning×1 are DB-tunable (faulty.weight_*).',
