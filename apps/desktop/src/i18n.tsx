...
const dict = {
  cs: {
    ...
    'settings.field.recipients': 'Příjemci',
    ...
    'settings.field.svcAlertsHelp': 'Sledovaná PC se zaškrtávají v Počítačích (🔔 Služby). Alert se pošle, až je služba mimo Running déle než debounce (ochrana proti flappingu při nočních restartech) a mimo okno údržby. Sdílí SMTP/příjemce/adresu dashboardu s diskovými alerty. Test uloží rozpracované nastavení sám. Whitelist navíc globálně schová odpovídající služby z dlaždice „Zastavené služby" i ze záložky Služby (tam přepínatelné „Hide whitelisted").',
  ...
  en: {
    ...
    'settings.field.recipients': 'Recipients',
