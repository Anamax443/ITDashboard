...
const dict = {
  cs: {
    ...
    'settings.section.reportEmailDesc': 'Příjemci strukturovaného přehledu (PC vs servery, offline, stav sběru). Report se posílá ručně tlačítkem na záložce Reporting.',
    'settings.field.reportEmailHelp': 'Prázdné = použijí se sdílení příjemci z Nastavení e-mailu. Odeslání spustíš na záložce Reporting („Odeslat e-mailem").',
    ...
    'reporting.title': 'Strukturovaný přehled',
    'reporting.help': 'Přehled celého parku: rozdělení PC vs servery (podle OS), stroje offline (právě nedostupné na síti, s dobou výpadku) a stav sběru. Tabulky lze exportovat (TXT/CSV s diakritikou) nebo poslat e-mailem stejný report. Aktualizuje se každých 30 s.',
    'reporting.machines': 'strojů',
    'reporting.servers': 'serverů',
    'reporting.stat.total': 'stroje',
    'reporting.stat.servers': 'servery',
    'reporting.stat.pcs': 'PC',
    'reporting.stat.active': 'online',
    'reporting.stat.offline': 'offline',
    'reporting.stat.disabled': 'zakázané',
    'reporting.stat.monitored': 'monitor.',
    'reporting.stat.failing': 'sběr selhává',
    'reporting.section.offline': 'Offline stroje',
    'reporting.section.servers': 'Servery',
    'reporting.section.pcs': 'PC',
    'reporting.col.machine': 'Stroj',
    'reporting.col.ip': 'IP',
    'reporting.col.status': 'Stav',
    'reporting.col.os': 'OS',
    'reporting.col.offlineFor': 'Offline',
    'reporting.status.active': 'online',
    'reporting.status.offline': 'offline',
    'reporting.status.disabled': 'zakázaný',
    'reporting.lastSeen': 'viděn',
    'reporting.noOffline': 'Žádné offline stroje',
    'reporting.sendEmail': 'Odeslat e-mailem',
    'reporting.sending': 'Odesílám…',
    'reporting.sendOk': 'Odesláno {recipients} příjemcům ({total} strojů, {offline} offline).',
    'reporting.search': 'Hledat (jméno, IP, OS)…',
    'reporting.selectAll': 'Vybrat vše',
    'reporting.clearVisible': 'Odebrat vše',
    'reporting.selectAllHint': 'Vybrat / odebrat všechny právě zobrazené stroje',
    'reporting.clear': 'Zrušit výběr',
    'reporting.noMatch': 'Žádný stroj neodpovídá filtru.',
    'reporting.col.type': 'Typ',
    'reporting.col.last': 'Poslední kontakt',
    'reporting.type.server': 'server',
    'reporting.failingTip': 'Sběr dat z tohoto stroje opakovaně selhává.',
    'reporting.sendSelectedHint': 'Odeslat e-mailem pouze zaškrtnuté stroje.',
    'reporting.sendVisibleHint': 'Nic není zaškrtnuto → odešle všechny právě zobrazené stroje (dle filtru a hledání).',
  ...
  en: {
    ...
    'settings.section.reportEmailDesc': 'Recipients of the structured overview (PC vs servers, offline, collection health). The report is sent manually from the Reporting tab.',
    'settings.field.reportEmailHelp': 'Empty = use the shared recipients from Email setup. Trigger the send on the Reporting tab ("Send by email").',
    ...
    'nav.reporting': 'Reporting',
    'reporting.title': 'Structured overview',
    'reporting.help': 'Whole-fleet overview: PC vs servers split (by OS), offline machines (currently unreachable on the network, with downtime), and collection health. Tables export (TXT/CSV with diacritics) or email the same report. Refreshes every 30s.',
    'reporting.machines': 'machines',
    'reporting.servers': 'servers',
    'reporting.stat.total': 'machines',
    'reporting.stat.servers': 'servers',
    'reporting.stat.pcs': 'PCs',
    'reporting.stat.active': 'online',
    'reporting.stat.offline': 'offline',
    'reporting.stat.disabled': 'disabled',
    'reporting.stat.monitored': 'monitored',
    'reporting.stat.failing': 'collect failing',
    'reporting.section.offline': 'Offline machines',
    'reporting.section.servers': 'Servers',
    'reporting.section.pcs': 'PCs',
    'reporting.col.machine': 'Machine',
    'reporting.col.ip': 'IP',
    ...
    'reporting.status.active': 'online',
    'reporting.status.offline': 'offline',
    'reporting.status.disabled': 'disabled',
    'reporting.lastSeen': 'seen',
    'reporting.noOffline': 'No offline machines',
    'reporting.sendEmail': 'Send by email',
    'reporting.sending': 'Sending…',
    'reporting.sendOk': 'Sent to {recipients} recipient(s) ({total} machines, {offline} offline).',
    'reporting.search': 'Search (name, IP, OS)…',
    'reporting.selectAll': 'Select all',
    'reporting.clearVisible': 'Deselect all',
    'reporting.selectAllHint': 'Select / deselect all currently shown machines',
    'reporting.clear': 'Clear selection',
    'reporting.noMatch': 'No machine matches the filter.',
    'reporting.col.type': 'Type',
    'reporting.col.last': 'Last contact',
    'reporting.type.server': 'server',
    'reporting.failingTip': 'Data collection from this machine keeps failing.',
    'reporting.sendSelectedHint': 'Email only the checked machines.',
    'reporting.sendVisibleHint': 'Nothing checked → emails all currently shown machines (per filter and search).',
